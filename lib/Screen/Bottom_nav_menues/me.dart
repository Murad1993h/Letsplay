...
import '../MainHome/my_profile.dart';
import '../auth/Developer_page.dart';
import '../me/leaderboard.dart';
import '../me/my_wallet.dart';
import '../me/purchased_diamonds.dart';
import '../me/statistics.dart';
                    ...
                    ListTile(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => developer_page()));
                      },
                      leading: Icon(
                        Icons.class_,
                        color: Colors.blue,
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        InkWell(
                          onTap: () async {
                            var url =
                                'https://youtube.com/channel/UC3cXSyBz0wKZt9R4AnG937A';
                        ...
                        InkWell(
                          onTap: () async {
                            var url =
                                'https://chat.whatsapp.com/Imy8lX9EDl33HGXZ0SfShS';
