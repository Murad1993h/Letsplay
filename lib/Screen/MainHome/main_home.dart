...
import '../Bottom_nav_menues/Play.dart';
import '../Bottom_nav_menues/me.dart';
import '../Bottom_nav_menues/shop.dart';
...
class _MainHomeState extends State<MainHome> with TickerProviderStateMixin {
  ...
  Future badge() async {
    ...
    var response =
    await http.get(Uri.parse(AppUrl.notice), headers: requestHeaders);
                  ...
                  status == 0
                    ...
                    child: TabBarView(
                      ...
                      children: [
                        play(
                          text_:
                          badge_text != null ? badge_text : 'ABsports',
                        ),
                        shop(),
                        store(),
                        me(),
