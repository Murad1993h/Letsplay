...
class _check_outState extends State<check_out> {
  ...
  Future withdraw(String title, String prics, String diamond_ammount,
                    ...
                    showDialog(
                        ...
                        builder: (BuildContext context) {
                          return AlertDialog(
                            ...
                            content:
                                Text("Are you sure you want to buy diamonds?"),
                            actions: <Widget>[
                              ElevatedButton(
                                child: Text("YES"),
                                onPressed: () {
                                  withdraw(widget.title!, widget.price!,
                                      widget.diamon_amount!, uid.text);
                                },
                              ),
                              ElevatedButton(
                                child: Text("NO"),
