...
import 'package:letsplay/Screen/Daily_matches/squad_final_join.dart';
                                                      ...
                                                      Text(' $indexof3',
                                                          style: TextStyle(
                                                              ...
                                                              fontWeight:
                                                                  FontWeight
                                                                      .bold)),
                                                      snapshot.data[index]['game_player_count']
                                                                          [i][
                                                                      'user_id'] !=
                                                                  0 &&
                                                              snapshot.data[index]
                                                          ...
                                                          : Row(
                                                              children: [
                                                                Checkbox(
                                                                    value: snapshot.data[index]['game_player_count'][i]['user_id'] ==
                                                                            0
                                                                        ? false
                                                                        : true,
                                                                    onChanged:
                                                                      ...
                                                                      v == true
                                                                          ...
                                                                          : selected2
                                                                              .remove(true);
                                                                      v == true
                                                                          ? slot.add(snapshot.data[index]['game_player_count'][i]
                                                                              [
                                                                              'id'])
                                                                          : slot.remove(snapshot.data[index]['game_player_count'][i]
                                                                              [
                                                                              'id']);
                                                                      v == true
                                                                          ? team_array.add(snapshot.data[index]['game_player_count'][i]
                                                                              [
                                                                              'team_type'])
                                                                          : team_array.remove(snapshot.data[index]['game_player_count'][i]
                                                                              [
                                                                              'team_type']);
                                                                      print(slot
                                                                          .toString());
                                                                      ...
                                                                      selected2.length <=
                                                                          ...
                                                                          ? setState(
                                                                              ...
                                                                              fake_id = snapshot.data[index]['game_player_count'][i]['id'];

                                                                              if (snapshot.data[index]['game_player_count'][i]['player_name'] == 'x' && snapshot.data[index]['game_player_count'][i]['user_id'] == player_id) {
                                                                                //   try_[index]
                                                                                // ['player_name'] = 'a';
                                                                                snapshot.data[index]['game_player_count'][i]['user_id'] = 0;
                                                                              } else {
                                                                                snapshot.data[index]['game_player_count'][i]['player_name'] = 'x';
                                                                                snapshot.data[index]['game_player_count'][i]['user_id'] = player_id;
                                                                              }
                                                                              v == true ? selected.add(true) : selected.remove(true);
                                                                              print(selected.toString());
                                                                            })
