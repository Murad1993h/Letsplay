...
import 'package:letsplay/Screen/Daily_matches/prize_details.dart';
import 'package:letsplay/Screen/Daily_matches/quad_join.dart';
import 'package:letsplay/Screen/Daily_matches/roome_details_popup.dart';
import 'package:letsplay/Screen/Daily_matches/solo_join_match.dart';
...
class _Daily_matces_clash_squad_freeState
  ...
  Future<List<dynamic>?> playApi() async {
    ...
    print("playApiURL::::::::::::::::${AppUrl.gamelist + widget.type!}");

    if (response.statusCode == 200) {

      var userData1 = jsonDecode(response.body)['data'];
      print('Play list ${response.body}');
      return userData1;
    } else {
  ...
  Future<List<dynamic>?> getOngoingApi() async {
...
print(token);
    ...
    var response = await http.get(Uri.parse(AppUrl.ongoin + "${widget.type}"),
        headers: requestHeaders);
    if (response.statusCode == 200) {
      print('Get post collected324' + response.body);
      var userData1 = jsonDecode(response.body)['data'];
  ...
  Future<List<dynamic>?> getResult() async {
    ...
    var response = await http.get(
        Uri.parse(AppUrl.baseURL + "auth/show/game/result/${widget.type}"),
        headers: requestHeaders);

    if (response.statusCode == 200) {
      print('Get ongoin collected5324' + response.body);
      var userData1 = jsonDecode(response.body)['data'];
